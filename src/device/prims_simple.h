...
#define NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY_FIXED 0
#define NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY_ADAPTIVE 1

#ifndef NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY
#define NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY_FIXED
#endif

#ifndef NCCL_EXPERIMENT_WAIT_BACKOFF_START_SPINS
#define NCCL_EXPERIMENT_WAIT_BACKOFF_START_SPINS 64
#endif

#ifndef NCCL_EXPERIMENT_WAIT_BACKOFF_MEDIUM_SPINS
#define NCCL_EXPERIMENT_WAIT_BACKOFF_MEDIUM_SPINS 512
#endif

#ifndef NCCL_EXPERIMENT_WAIT_BACKOFF_SMALL_NS
#define NCCL_EXPERIMENT_WAIT_BACKOFF_SMALL_NS 32
#endif

#ifndef NCCL_EXPERIMENT_WAIT_BACKOFF_LARGE_NS
...
#error "NCCL_EXPERIMENT_WAIT_BACKOFF_OP must be 0(all), 1(recv), 2(send), or 3(recvsend)"
    ...
    NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY > NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY_ADAPTIVE
#error "NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY must be 0(fixed) or 1(adaptive)"
#endif

#if NCCL_EXPERIMENT_WAIT_BACKOFF_EVERY <= 0
#error "NCCL_EXPERIMENT_WAIT_BACKOFF_EVERY must be positive"
#endif

#if NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY == NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY_FIXED
#define NCCL_EXPERIMENT_WAIT_BACKOFF_ENABLED (NCCL_EXPERIMENT_WAIT_BACKOFF_SLEEP_NS > 0)
#else
#define NCCL_EXPERIMENT_WAIT_BACKOFF_ENABLED \
