...
NCCL_EXPERIMENT_POLL_STATS ?= 0
NCCL_EXPERIMENT_POLL_STATS_TIMING ?= 1
...
ifneq ($(NCCL_EXPERIMENT_WAIT_BACKOFF_SLEEP_NS),0)
...
ifneq ($(NCCL_EXPERIMENT_POLL_STATS),0)
NVCUFLAGS += -DNCCL_EXPERIMENT_POLL_STATS=$(NCCL_EXPERIMENT_POLL_STATS)
NVCUFLAGS += -DNCCL_EXPERIMENT_POLL_STATS_TIMING=$(NCCL_EXPERIMENT_POLL_STATS_TIMING)
endif
