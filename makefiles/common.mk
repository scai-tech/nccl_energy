...
NCCL_EXPERIMENT_WAIT_BACKOFF_START_SPINS ?= 64
NCCL_EXPERIMENT_WAIT_BACKOFF_MEDIUM_SPINS ?= 512
NCCL_EXPERIMENT_WAIT_BACKOFF_SMALL_NS ?= 32
NCCL_EXPERIMENT_WAIT_BACKOFF_LARGE_NS ?= 128
NCCL_EXPERIMENT_WAIT_STATS ?= 0
...
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_SLEEP_NS=$(NCCL_EXPERIMENT_WAIT_BACKOFF_SLEEP_NS)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_EVERY=$(NCCL_EXPERIMENT_WAIT_BACKOFF_EVERY)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_OP=$(NCCL_EXPERIMENT_WAIT_BACKOFF_OP)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_POLICY=$(NCCL_EXPERIMENT_WAIT_BACKOFF_POLICY)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_START_SPINS=$(NCCL_EXPERIMENT_WAIT_BACKOFF_START_SPINS)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_MEDIUM_SPINS=$(NCCL_EXPERIMENT_WAIT_BACKOFF_MEDIUM_SPINS)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_SMALL_NS=$(NCCL_EXPERIMENT_WAIT_BACKOFF_SMALL_NS)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_BACKOFF_LARGE_NS=$(NCCL_EXPERIMENT_WAIT_BACKOFF_LARGE_NS)
NVCUFLAGS += -DNCCL_EXPERIMENT_WAIT_STATS=$(NCCL_EXPERIMENT_WAIT_STATS)
